    ...
    <>
      ...
      >
        ...
        >
          ...
          <div className="text-container">
            ...
            <div className="buttons-initial">
              <Link to="/planos">
                <button className="services-projects-button">Serviços</button>
              </Link>
              <a
                href={CVFile}
        ...
        <section aria-label="Sobre mim" className="about-me-home reveal">
          ...
          <p>
            Sou desenvolvedora full-stack, apaixonada por tecnologia e inovação.
            Tenho experiência em front-end, back-end e análise de dados,
            utilizando ferramentas como ReactJS, AngularJS, NodeJS, Java +
            Spring Boot, SQL Server, MySQL e Power BI. Já atuei no
            desenvolvimento mobile com React Native e em projetos de

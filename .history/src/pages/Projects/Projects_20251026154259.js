...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      l2: "HTML",
      l3: "CSS",
      description: "O Power BI é uma ferramenta de análise de dados e visualização da Microsoft que oferece uma interface intuitiva para transformar dados em informações acionáveis.",
      buttonText: "Ver dashboards",
    },
    {
      id: 3,

          ...
          <div className="overlay-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="overlay-body">
              <div className="overlay-left">
                {/* Estado local para a imagem aberta */}
                {selectedImageSrc && (
                  <div
                ...
                selectedProject.otherimages[0].type === "video" ? (
                  ...
                  selectedProject.otherimages?.length > 0 && (
                    <img
                      ...
                      onClick={() =>
                        setSelectedImageSrc(selectedProject.otherimages[0].src)
                      }
                    />
                  )
                )}

                {/* Galeria 2x2 com clique */}
                  ...
                  {selectedProject.otherimages?.slice(1).map((item, index) =>
                    item.type === "video" ? (
                      ...
                      <img
                        ...
                        onClick={() => setSelectedImageSrc(item.src)} // clique abre imagem
                      />
                    )
                  )}
                </div>

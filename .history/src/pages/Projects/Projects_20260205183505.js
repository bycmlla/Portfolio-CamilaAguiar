...
import Jtdtransportes2 from "../../assets/images/projects/jtdtransportes3.png"
import Jtdtransportes2 from "../../assets/images/projects/jtdtransportes4.png"
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      text: "Site corporativo da empresa JTD Transportes",
      images: [DepthImageCard],
      otherimages: [{ type: "image", src: RoboRosa }],
      link: "#/rosa",
      repoLink: "https://github.com/bycmlla/StereocopicVision.git",

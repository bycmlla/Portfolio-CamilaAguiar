...
const Projects = () => {
  ...
  id: 1,
  title: "PsyRPG",
  text: "Aplicativo de Gamificação de Rotinas...",
  otherImages: [PsyVideo, Dashboard1, Dashboard1, Dashboard1, Dashboard1],
  repoLink: "...",
  icons: [PowerBiIcon],
  iconsBlack: [BlackPBI],
  l1: "DAX",
  l2: "HTML",
  l3: "CSS",
  description: "O Power BI é uma ferramenta...",
            ...
            <div className="overlay-body">
              <div className="overlay-left">
                ...
                <div className="overlay-buttons">
                  ...
                  {selectedProject.buttonText && selectedProject.link && (
                    <button
